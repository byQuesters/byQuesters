<h1 align="center"><b>Hello World! I'm Questers </b><img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
...
<table align="center" border="0" cellpadding="10" cellspacing="0" style="margin: 0 auto; max-width: 900px;">
  <tr>
  <!-- Certificado 0 -->
    <td align="center" style="padding: 10px;">
      <a href="URL_CERT_1" target="_blank">
        <img src="https://github.com/user-attachments/files/26484774/Scrum.Fundation.Profesional.Certification.pdf" alt="Scrum Fundation Profesional Certification" style="width: 180px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
      </a>
      <p><strong>SFPC</strong></p>
    </td>
    <!-- Certificado 1 -->
    <td align="center" style="padding: 10px;">
      <a href="URL_CERT_1" target="_blank">
        <img src="https://github.com/user-attachments/files/26484706/CertificadoScrumM-Ambriz.Chavez.Jose.Alberto.pdf" alt="Certificado 1" style="width: 180px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
      </a>
      <p><strong>UCOL Scrum Master</strong></p>
    </td>
    <!-- Certificado 2 -->
    <td align="center" style="padding: 10px;">
      <a href="URL_CERT_2" target="_blank">
        <img src="https://github.com/user-attachments/files/26484707/AWS.Technical.Essentials.pdf" alt="AWS Technical Essentials" style="width: 180px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
      </a>
      <p><strong>AWS Technical Essentials</strong></p>
    </td>
    <!-- Certificado 3 -->
    <td align="center" style="padding: 10px;">
      <a href="URL_CERT_3" target="_blank">
        <img src="https://github.com/user-attachments/files/26484712/AWS.Partner.Acreditation.pdf" alt="AWS Partner Acreditation" style="width: 180px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
      </a>
      <p><strong>AWS Partner Acreditation</strong></p>
    </td>
 <!-- Certificado 4 -->
    <td align="center" style="padding: 10px;">
      <a href="URL_CERT_3" target="_blank">
        <img src="https://github.com/user-attachments/files/26484784/AWS.Cloud.Economics.pdf" alt="AWS Cloud Economics" style="width: 180px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
      </a>
      <p><strong>AWS Cloud Economics</strong></p>
    </td>
  </tr>
</table>
